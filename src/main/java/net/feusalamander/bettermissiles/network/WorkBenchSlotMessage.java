...
public class WorkBenchSlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public WorkBenchSlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public WorkBenchSlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(WorkBenchSlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(WorkBenchSlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		BettermissilesMod.addNetworkMessage(WorkBenchSlotMessage.class, WorkBenchSlotMessage::buffer, WorkBenchSlotMessage::new, WorkBenchSlotMessage::handler);
	}
}
