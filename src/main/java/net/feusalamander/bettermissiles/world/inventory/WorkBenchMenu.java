...
public class WorkBenchMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public WorkBenchMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			BettermissilesMod.PACKET_HANDLER.sendToServer(new WorkBenchSlotMessage(slotid, x, y, z, ctype, meta));
			WorkBenchSlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
