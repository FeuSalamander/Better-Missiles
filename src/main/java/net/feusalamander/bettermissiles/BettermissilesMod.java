...
@Mod("bettermissiles")
public class BettermissilesMod {
	public static final Logger LOGGER = LogManager.getLogger(BettermissilesMod.class);
	public static final String MODID = "bettermissiles";
	...
	public BettermissilesMod() {
		...
		BettermissilesModBlockEntities.REGISTRY.register(bus);
