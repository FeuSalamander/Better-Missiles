...
public class GolgotmissileEntity extends PathfinderMob {
	public GolgotmissileEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(BettermissilesModEntities.GOLGOTMISSILE.get(), world);
	}

	public GolgotmissileEntity(EntityType<GolgotmissileEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		GolgotexplosionProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		GolgotrecupProcedure.execute(entity, sourceentity);
		return retval;
	}
