...
@OnlyIn(Dist.CLIENT)
public class GolgotmissileRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(GolgotmissileEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelgolgot(), 0f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("bettermissiles:textures/golgot.png");
					}
				};
			});
		}
