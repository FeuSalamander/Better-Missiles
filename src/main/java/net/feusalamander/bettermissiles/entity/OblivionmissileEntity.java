...
public class OblivionmissileEntity extends PathfinderMob {
	public OblivionmissileEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(BettermissilesModEntities.OBLIVIONMISSILE.get(), world);
	}

	public OblivionmissileEntity(EntityType<OblivionmissileEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		MissiletestEntityDiesProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		MissiletestRightClickedOnEntityProcedure.execute(entity, sourceentity);
		return retval;
	}
