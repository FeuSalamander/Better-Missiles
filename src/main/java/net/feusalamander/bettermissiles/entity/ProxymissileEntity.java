...
import net.feusalamander.bettermissiles.entity.renderer.ProxymissileRenderer;
...
public class ProxymissileEntity extends BettermissilesModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 3.25f)).build("proxymissile").setRegistryName("proxymissile");

	public ProxymissileEntity(BettermissilesModElements instance) {
		super(instance, 25);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ProxymissileRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void onDeath(DamageSource source) {
			...
			ProxyexplosionProcedure.executeProcedure(Stream
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			ProxyrecupProcedure.executeProcedure(
		...
		public void baseTick() {
			...
			MissiletestOnEntityTickUpdateProcedure
